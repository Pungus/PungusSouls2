...
/*            BuildPiece CrystalAnvil = new("wep", "CrystalAnvil");
            ...
            {
                LocationManager.Location FirelinkShrine = new("location2", "FireLinkShrine")
                {
                ...
                {
                    LocationManager.Location undeadasylum = new("location2", "undeadasylum1")
                    {
                        MapIcon = "firelinkicon.png",
                        Rotation = Rotation.Fixed,
                        ShowMapIcon = ShowIcon.Explored,
...
/*            PiecePrefabManager.RegisterPrefab(PrefabManager.RegisterAssetBundle("souls"), "HollowSoldierSpawner", false);
            ...
            PiecePrefabManager.RegisterPrefab(PrefabManager.RegisterAssetBundle("souls"), "sfx_taurus_attack1", false);
            PiecePrefabManager.RegisterPrefab(PrefabManager.RegisterAssetBundle("souls"), "sfx_taurus_weaponhit1", false);
